...
<center>
	<a href="<?php echo esc_url( $site_url ); ?>"><?php echo esc_html__( 'Découvrir les ateliers', 'woocommerce-smart-coupons' ); ?></a>
	<?php
	...
	if ( true === $is_print ) {
		...
		?>
		|
		<a href="<?php echo esc_url( $print_coupon_url ); ?>" target="_blank"><?php echo esc_html__( 'Imprimer', 'woocommerce-smart-coupons' ); ?></a>
		<?php
	}
	?>
</center>
