...
class Cookie_Law_Info_Admin {
	...
	*/
	...
	{	
		...
		<div class="form-field">
			...
			<input type="radio" name="CLIdefaultstate" value="enabled" checked /><?php _e( 'Enabled', 'cookie-law-info' ); ?>
			<input type="radio" name="CLIdefaultstate" value="disabled"/><?php _e( 'Disabled', 'cookie-law-info' ); ?>	
	...
	*/
	public function cookie_save_defaultstate($term_id)
	{
	    ...
	    {
	        update_term_meta($term_id,'CLIdefaultstate','enabled');
		}
	...
	*/
	public function initialize_cookie_defaultstate()
	{
	    ...
	    if(!empty($terms)){
	        ...
	        update_term_meta($term->term_id, 'CLIdefaultstate','enabled');
	        }
	    }
	}
