...
class Cookie_Law_Info_Cli_Themes
{
	...
	*/
	...
	public static function cli_themeblock($data)
	{
		...
		$bar_hd='<h5 style="'.$config['heading']['style'].'" data-cli-id="cli_theme_hd" class="cli_theme_hd" data-cli-bartype="'.$config['bar']['type'].'" title="Cookie Bar heading">'.$config['heading']['text'].'</h5>';
		...
		?>
		<div style="<?php echo $config['bar']['style'];?>" title="Cookie Bar" data-cli-id="cli_theme_bar" class="cli_theme_bar" data-cli-bartype="<?php echo $config['bar']['type'];?>">
