...
class Cookie_Law_Info {
	...
	*/
	...
	public static function get_default_settings($key='')
	{
		$settings_v0_9 = array(
			...
			'border' 						=> '#b1a6a6c2',
			'border_on'						=> true,
			'bar_style'				=> array(array('padding','13px 20px'),array('box-sizing','border-box')),
			'bar_hd_style'				=> array(),
	    ...
	    'button_4_text'					=> 'Cookie settings',
			...
			'button_4_button_colour' 		=> '#ffffff00',
			'button_4_button_size' 			=> 'medium',
			'button_4_style'				=> array(array('border-bottom','1px solid'),array('padding-bottom','1px')), 
    ...
    */
	...
	/**
	 * Set consent version for renewing consent
	 *
	 * @since    2.2.2
	 * @access   public
	 */
	public static function wt_cli_set_consent_version()
	{
