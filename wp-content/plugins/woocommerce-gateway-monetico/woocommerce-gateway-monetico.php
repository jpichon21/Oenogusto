...
function init_gateway_monetico() {
	...
	if(!defined("PASSERELLE_MONETICO_VERSION")) define("PASSERELLE_MONETICO_VERSION", "2.0.5");
	...
	class WC_Gateway_Monetico extends WC_Payment_Gateway {
		...
		public function admin_options() {
			...
			echo '<tr><td>'.__("Return URL CGI2",'monetico').'</td><td><pre>'.get_site_url().'/?wc-api=WC_Gateway_Monetico</pre></td></tr>';
	...
	<input type="radio" name="mode" id="fifory" value="fifory"><label for="fifory">Fivory</label>';*/
		...
		public function generate_monetico_form( $order_id ) {
			echo "<div class='monetico-form col-9 centered'>"; 
...
<?php		
		...
		function receipt_page( $order ) {
			...
			echo '<p class="monetico-thanks">'.apply_filters( 'monetico_change_bank_msg', __("Thank you for your order, please click on the button below to make payment to our bank.", "monetico")).'</p>';
